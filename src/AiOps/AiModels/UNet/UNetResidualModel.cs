...
namespace AiOps.AiModels.UNet
{
	...
	public sealed class UNetResidualModel : Module<Tensor, Tensor>
	{
		...
		public UNetResidualModel(IHyperParameter para) : base(nameof(UNetResidualModel))
		{
			...
			var bottleneckConv = new DoubleConvolutionBuilder(
				$"Bottleneck", inC, filterSizes[para.Depth], para.UseInstanceNorm, para.UseDropout, para.UseChannelAttention, device, precision).Build();
